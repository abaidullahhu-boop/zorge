...
const ADVANTAGES = [
  {
    ...
    width: 720,
    height: 900,
    text: "Spacious and elegant lobbies welcome residents with impeccable interiors and a cozy lounge area, embodying the idea of impeccable style and understated luxury. Immerse yourself in an atmosphere of refined comfort comparable to the world's finest hotels.",
  },
  {
    id: 'concierge',
    titleLines: ['concierge', 'service'],
    image: advantages2,
    width: 720,
    height: 780,
    text: 'A personal assistant who takes care of your time and comfort. Transportation arrangements, ticket reservations, or everyday tasks — everything will be done with attention and professionalism.',
  },
  {
    id: 'community',
    titleLines: ['community', 'center'],
    image: advantages3,
    width: 720,
    height: 780,
    text: "Playing, forgetting about everything in the world, sharing secrets with friends, drawing cartoon characters — the children's room opens the door to another world.",
  },
  {
    id: 'coworking',
    titleLines: ['co-working', 'space'],
    image: advantages4,
    width: 720,
    height: 900,
    text: 'If you have a brilliant business idea, discuss it with your colleagues without leaving your home. Spacious meeting rooms with high panoramic windows will help you present your project in the best light.',
  },
  {
    id: 'courtyard',
    titleLines: ['courtyard lounge', 'with fireplace', 'and fountain'],
    image: advantages5,
    width: 720,
    height: 900,
    text: 'A secluded corner in the very center of the complex. Greenery, stylish design solutions, and cozy relaxation areas create an atmosphere of calm and harmony.',
  },
]
